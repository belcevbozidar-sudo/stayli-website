document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ...
    bg: {
      ...
      'hero.title'       : 'Дигитални платформи от най-висок клас за агенции за недвижими имоти',
      'hero.subtitle'    : 'Ние създаваме изцяло авторски уебсайтове за агенции в премиум сегмента.<br>Спечелете доверието на продавачите и увеличете запитванията с дизайн от световна класа.',
      'hero.search_btn'  : 'Вижте как',
      ...
      'port.card1.tag'   : 'Имоти от висок клас',
      'port.card1.desc'  : 'Платформа за крайбрежни имоти с интерактивно търсене по карта.',
      'port.card2.tag'   : 'Бутикова агенция',
      'port.card2.desc'  : 'Минималистично представяне с бързо и филтрируемо портфолио.',
      'port.card3.tag'   : 'Бизнес имоти',
      'port.card3.desc'  : 'Корпоративно портфолио с дигитални стаи за инвеститори.',
      'port.card4.tag'   : 'Ново строителство',
      'port.card4.desc'  : 'Микросайт с автоматизиран процес за резервации на жилища в нов проект.',
